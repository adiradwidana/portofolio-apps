...
public class CircleIndicator extends LinearLayout {
    ...
    private int mAnimatorResId = R.animator.anim_alpha_indicator;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(me.relex.circleindicator.R.styleable.CircleIndicator_ci_animator,
                R.animator.anim_alpha_indicator);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.anim_alpha_indicator, 0, me.relex.circleindicator.R.drawable.white_radius, me.relex.circleindicator.R.drawable.white_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.anim_alpha_indicator : mAnimatorResId;
    ...
    private final OnPageChangeListener mInternalPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (mLastPosition > -1) {
                position = LoopViewPager.toRealPosition(position, mViewpager.getAdapter().getCount());
            }
    ...
    private void addIndicator(int orientation, @DrawableRes int backgroundDrawableId,
                              Animator animator, final int index) {
